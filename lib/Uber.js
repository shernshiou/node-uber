...
var resources = {
    ...
    Reminders: require('./resources/riders/Reminders'),
    DriverPayments: require('./resources/drivers/Payments'),
    DriverProfile: require('./resources/drivers/Profile'),
    DriverTrips: require('./resources/drivers/Trips')
};
